#!/usr/bin/env node
// Seeds CMU ARCTIC harvested voices into R2 + database
import fs from "fs";
...
const VOICES_DIR = path.join(__dirname, "system-voices-cmu");
...
async function main() {
  ...
  console.log(`Seeding ${names.length} CMU ARCTIC voices...`);
